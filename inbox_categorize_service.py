...
def _post_to_claude(api_key: str, prompt: str, max_tokens: int) -> dict[str, Any]:
    # #195: thin delegator over the shared claude_client. Haiku —
    # inbox classification is well-defined; Sonnet would be overkill.
    # Name + signature preserved so patch("...._post_to_claude") mocks
    # keep working.
